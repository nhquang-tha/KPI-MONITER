...
# ==============================================================================
# 2. CÁC HÀM TIỆN ÍCH (Chuẩn hóa chữ, lọc rác, xử lý dấu phẩy)
# ==============================================================================
...
def clean_header(col_name, itype=None, raw_headers=None):
    ...
    # BỘ MAPPING CHUẨN DỰA TRÊN FILE CỦA BẠN (Ép cứng để chống lệch cột)
    if itype == 'config3g':
...
# ==============================================================================
# 3. MODELS DATABASE (Cấu trúc dữ liệu chuẩn xác)
# ==============================================================================
...
def import_data():
    ...
    if request.method == 'POST':
        ...
        # NHÁNH IMPORT CÁC LOẠI RF/KPI/POI VÀ THUẬT TOÁN GỘP FILE 3G
        else:
            ...
            for file in files:
                try:
                    ...
                    # Tự động nhận diện nếu người dùng tải lên chung 2 file 3G
                    current_itype = itype
                    ...
                    for df in chunks:
                        ...
                        for row in df.to_dict('records'):
                            ...
                            # TỰ ĐỘNG ÉP IN HOA KHÓA CHÍNH (Đảm bảo 3G_BSN khớp hoàn toàn với 3g_bsn)
                        ...
                        if is_rf_model and records_to_process:
                            ...
                            for cr in records_to_process:
                                ...
                                if cc in existing_rf_map:
                                    ...
                                    # CHỈ INSERT MỚI NẾU FILE KHÔNG PHẢI LÀ CELL_3G
            ...
            if itype == '3g':
                try:
                    ...
                    if rf3g_inserts:
                        ...
                        flash(f'Đã tự động gộp {len(rf3g_inserts)} trạm hoàn chỉnh vào Danh bạ RF 3G!', 'info')
...
# ==============================================================================
# 6. CÁC ROUTES TIỆN ÍCH (Telegram, Backup/Restore, User...)
# ==============================================================================
