...
# ==============================================================================
# 3. MODELS DATABASE (Nén dòng để tiết kiệm dung lượng)
# ==============================================================================
...
{% extends "base" %}
{% block content %}
<div class="card mb-4"><div class="card-header bg-white"><span class="fs-5 fw-bold">{{ title }}</span></div><div class="card-body">
    ...
    {% elif active_page == 'qoe_qos' %}
        <form method="GET" action="/qoe-qos" class="row g-3 mb-4 bg-light p-3"><div class="col-md-8"><input type="text" name="cell_name" class="form-control" placeholder="Cell Name 4G..." value="{{ cell_name_input }}" required></div><div class="col-md-4"><button type="submit" class="btn btn-primary w-100">Xem</button></div></form>
...
# ==============================================================================
# 5. API & ROUTES CỐT LÕI (NHẬP DỮ LIỆU & GỘP FILE 3G)
# ==============================================================================
        ...
        # 2. NHÁNH IMPORT RF/KPI VÀ THUẬT TOÁN GỘP FILE 3G
            ...
            for file in files:
                try:
                    ...
                    # NHẬN DIỆN THÔNG MINH FILE 3G (Config hay Cell?)
                    current_itype = itype
                    ...
                    for df in chunks:
                        ...
                        for row in df.to_dict('records'):
                            ...
                            # ÉP CHUẨN IN HOA ĐỂ KHÔNG BAO GIỜ BỊ LỆCH KHÓA CHÍNH (Vd: 3G_BSN001 == 3g_bsn001)
                        ...
                        if is_rf_model and records_to_process:
                            ...
                            for cr in records_to_process:
                                ...
                                if cc in existing_rf_map:
                                    ...
                                    # CHỈ TẠO RECORD MỚI NẾU FILE ĐANG UPLOAD KHÔNG PHẢI LÀ FILE BỔ SUNG (CELL_3G)
            ...
            # TỰ ĐỘNG GỘP 2 BẢNG CONFIG VÀ CELL VÀO RF3G CHÍNH SAU KHI NẠP XONG
            if itype == '3g':
                try:
...
# ==============================================================================
# 6. CÁC ROUTES KHÁC (Telegram, Backup/Restore, User...)
# ==============================================================================
...
def optimize():
    ...
    return render_page(CONTENT_TEMPLATE, title="Tối ưu QoE", active_page='optimize', optimized_data=[], latest_week=sel_w, all_weeks=all_w)
...
def backup_restore():
    ...
    return render_page(BACKUP_RESTORE_TEMPLATE, title="Backup", active_page='backup_restore', kpi_rows=list(zip_longest(d3, d4, d5)), next_qoe=next_w_str, next_qos=next_w_str)
